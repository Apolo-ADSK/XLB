...
class PrecisionCaster(Operator):
    ...
    def _construct_warp(self):
        ...
        from_lattice_vec = wp.types.vector(self.velocity_set.q, dtype=self.input_precision)
        to_lattice_vec = wp.types.vector(self.velocity_set.q, dtype=self.output_precision)
